...
class PaymentGatewayController extends Controller
{
    ...
    public function pay(Request $request)
    {
        ...
        try {
            ...
            $responseURL = "http://cebu.iacademy.edu.ph/site/awesome/".$request->description;
            $cancelURL = $modePayment->pmethod == 'onlinebanktransfer' ? 'http://cebu.iacademy.edu.ph/site/awesome/'.$request->description : route('cancel-payment');
