...
class PaymentGatewayController extends Controller
{
    ...
    public function pay(Request $request)
    {
        ...
        try {
            ...
            $responseURL = "http://103.225.39.200//site/awesome/".$request->description;
            $cancelURL = $modePayment->pmethod == 'onlinebanktransfer' ? 'http://103.225.39.200//site/awesome/'.$request->description : route('cancel-payment');
